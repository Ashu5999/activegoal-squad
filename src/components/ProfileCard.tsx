...
const ProfileCard = ({ 
  ...
  return (
    <Card className="overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-purple-200 dark:border-purple-900">
      <CardHeader className="p-0">
        <div className="h-28 purple-gradient" />
      </CardHeader>
      <CardContent className="pt-0 -mt-14 text-center">
        ...
        <h3 className="font-bold text-xl mt-3 font-montserrat">{name}</h3>
        ...
        <div className="grid grid-cols-2 gap-4 my-5 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg mt-4">
      ...
      <CardFooter className="flex justify-center pt-0 pb-4">
        {isCurrentUser ? (
          ...
          <Button 
            variant="default" 
            size="sm" 
            className="purple-gradient shadow-md hover:shadow-lg hover:opacity-90 text-white transition-all"
